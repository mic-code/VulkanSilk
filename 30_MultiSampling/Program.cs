...
unsafe class HelloTriangleApplication
{
    ...
    const string ModelPath = "../../../../28_ModelLoading/viking_room.obj";
    const string TexturePath = "../../../../28_ModelLoading/viking_room.png";
    ...
    void CreateRenderPass()
    {
        ...
        AttachmentReference colorAttachmentResolveReference = new()
        {
            Attachment = 2,
            Layout = ImageLayout.ColorAttachmentOptimal
        };
    ...
    {
        var vertShaderCode = System.IO.File.ReadAllBytes("../../../../27_DepthBuffering/vert.spv");
        var fragShaderCode = System.IO.File.ReadAllBytes("../../../../26_TextureMapping/frag.spv");
    ...
    void CreateFramebuffers()
    {
        ...
        {
            var attachments = stackalloc[] { colorImageView, depthImageView, swapChainImageViews[i] };
    ...
    void CreateDepthResources()
    {
        ...
        CreateImage(swapChainExtent.Width, swapChainExtent.Height, 1, msaaSamples, format, ImageTiling.Optimal, ImageUsageFlags.DepthStencilAttachmentBit, MemoryPropertyFlags.DeviceLocalBit, ref depthImage, ref depthImageMemory);
    ...
    Format FindDepthFormat()
    {
        Format[] formats = [Format.D32Sfloat, Format.D32SfloatS8Uint, Format.D24UnormS8Uint];
        return FindSupportFormat(formats, ImageTiling.Optimal, FormatFeatureFlags.DepthStencilAttachmentBit);
    }

    Format FindSupportFormat(Format[] candidates, ImageTiling tiling, FormatFeatureFlags features)
    {
    ...
    void CreateImage(uint width, uint height, uint mipLevels, SampleCountFlags sampleCount, Format format, ImageTiling tiling, ImageUsageFlags usage, MemoryPropertyFlags properties, ref Image image, ref DeviceMemory imageMemory)
    {
        Extent3D extent = new()
        {
            Width = width,
    ...
    {
        var size = (uint)(sizeof(uint) * indices.Length);
        Buffer stagingBuffer = default;
        DeviceMemory stagingBufferMemory = default;
