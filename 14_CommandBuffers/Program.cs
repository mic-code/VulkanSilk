...
unsafe class HelloTriangleApplication
{
    ...
    void CreateCommandBuffer()
    {
        ...
        if (vk.AllocateCommandBuffers(device, in commandBufferAllocateInfo, out commandBuffer) != Result.Success)
            throw new Exception("failed to allocate command buffers!");
    }

    void recordCommandBuffer(CommandBuffer commandBuffer, int imageIndex)
    {
